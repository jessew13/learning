...
public class AsciiTextAnimation {
    ...
    public static void main(String[] args){
        ...
        String[][] matrix = new String[VERTICAL_LENGTH][(4 + NUM_SPACES) * numChars - NUM_SPACES];  // 6, representing horizontal width and numSpaces, could be a constant, or make it (4+numSpaces) * numChars - numSpaces
